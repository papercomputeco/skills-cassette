...
const artifactPrefix = "skills-cassette"
...
func (t *SkillsCassette) upload(ctx context.Context, opts *uploadOpts) error {
...
func (t *SkillsCassette) ReleaseLatest(
	ctx context.Context,
	...
	artifacts := t.buildVersionedRelease(ctx, version)
...
func (t *SkillsCassette) Nightly(
	...
	artifacts := t.buildVersionedRelease(ctx, "nightly")
	err := t.upload(ctx, &uploadOpts{
		artifacts:       artifacts,
...
// UploadInstallSh uploads the install script under the skills-cassette namespace.
func (t *SkillsCassette) UploadInstallSh(
	ctx context.Context,
