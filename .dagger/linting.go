...
func (t *SkillsCassette) lintOpts() dagger.GolangcilintOpts {
	base := t.goContainer().
		WithExec([]string{
			"go", "install",
...
//
// +check
func (t *SkillsCassette) CheckLint(ctx context.Context) (string, error) {
...
func (t *SkillsCassette) FixLint(ctx context.Context) *dagger.Directory {
